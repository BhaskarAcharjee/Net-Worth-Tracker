...
export const investment = <i className="fa-solid fa-money-bill-trend-up"></i>
export const stocks = <i className="fa-solid fa-arrow-trend-up"></i>
export const bitcoin = <i className="fa-brands fa-bitcoin"></i>
export const cashback = <i className="fa-solid fa-wallet"></i>
export const gift = <i className="fa-solid fa-gift"></i>
export const piggy = <i className="fa-solid fa-piggy-bank"></i>

// Expense Categories
export const book = <i className="fa-solid fa-graduation-cap"></i>
export const food = <i className="fa-solid fa-basket-shopping"></i>
export const medical = <i className="fa-solid fa-briefcase-medical"></i>
export const recharge = <i className="fa-solid fa-receipt"></i>
export const transfer = <i className="fa-solid fa-rocket"></i>
export const tv = <i className="fa-solid fa-tv"></i>
export const takeaway = <i className="fa-solid fa-utensils"></i>
export const travel = <i className="fa-solid fa-route"></i>
export const clothing = <i className="fa-solid fa-cart-shopping"></i>
